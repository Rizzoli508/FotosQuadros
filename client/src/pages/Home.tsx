              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                  ...
                  <div className="relative rounded-2xl border-2 border-primary/15 bg-primary/5 p-8 flex flex-col shadow-lg">
                    ...
                    <div className="flex flex-col items-center text-center mb-6 mt-3">
                      ...
                      <div className="flex items-baseline justify-center gap-2 mb-1">
                        ...
                        <span className="flex items-end gap-1">
                          ...
                          <span className="text-primary text-5xl font-serif font-bold">19,90</span>
                        </span>
                      </div>
                    ...
                    <button
                      onClick={() => openCheckout('Retrato Digital HD retravium', 19.9, false)}
                  ...
                  <div className="rounded-2xl p-7 flex flex-col" style={{ background: '#faf8f4', border: '2px solid #efe8d8' }}>
                    ...
                    <div className="text-center mb-6">
                      ...
                      <div className="flex items-end justify-center gap-1 mb-2">
                        ...
                        <span className="text-gray-900 font-serif font-bold leading-none" style={{ fontSize: '56px', lineHeight: 1 }}>19,90</span>
                      </div>
                      <p className="text-gray-400 text-sm">R$ 19,90 por retrato</p>
                    </div>
                    ...
                    <button
                      onClick={() => { setPlansOpen(false); openCheckout('Retrato Digital HD retravium', 19.9, false); }}
